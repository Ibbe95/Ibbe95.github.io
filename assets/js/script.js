...
(function () {
  ...
  const dict = {
    sv: {
      ...
      "projects.2.tag": "Datakvalitet & spårbarhet",
      "projects.2.title": "“Identitetsregister” — konsolidering av spridda identiteter",
      "projects.2.s": "Situation: Identiteter — inklusive maskin-/systemidentiteter — var spridda över Trafikförvaltningen och bland partners, underleverantörer och trafikutövare, vilket försvårade överblick och spårbarhet.",
      "projects.2.a": "Insats: Bidrog till ett omfattande projekt för att samla dessa i ett gemensamt identitetsregister, med fokus på säkerhet, spårbarhet och datakvalitet över hela ekosystemet av parter.",
      "projects.2.r": "Resultat: Bättre överblick över samtliga identiteter — mänskliga och icke-mänskliga — i hela leverantörskedjan, vilket stärkte säkerhet och datakvalitet.",
      "projects.3.tag": "Drift & IGA",
      "projects.3.title": "“Identitetssäkerhet” — driftstöd för Omada",
      "projects.3.s": "Situation: Ett pågående driftprojekt kring Omada (IGA-systemet) behövde stöd i uppföljning och dokumentationshantering.",
      "projects.3.a": "Insats: Stöttade som specialist i uppföljning av Omada, med ansvar för dokumentationshantering, diarieföring och löpande koordinering.",
      "projects.3.r": "Resultat: Ett mindre men viktigt driftprojekt som höll systemet och dess dokumentation i gott skick.",
      "projects.4.tag": "Governance",
      "projects.4.title": "Från PowerPoint till Atlassian",
      "projects.4.s": "Situation: Projektplanering för gruppen “Operativ säkerhet” skedde manuellt i PowerPoint — svårt att följa upp status i realtid för 28 personer.",
      "projects.4.a": "Insats: Migrerade hela planeringen till en dynamisk Jira/Atlassian-vy, tog fram DoR/DoD som leveranskriterier och höll workshops för både fastanställda och konsulter.",
      "projects.4.r": "Resultat: Samlad, uppdaterad överblick för 5 team och tydligare leveranskriterier i hela gruppen.",
      "projects.5.tag": "AI & säkerhet",
      "projects.5.title": "AI-Champions",
      "projects.5.s": "Situation: Behov av samlad vägledning kring AI-verktyg (t.ex. Copilot) utifrån NIS2, GDPR och informationssäkerhet.",
      "projects.5.a": "Insats: Drev initiativet tillsammans med andra projektledare och agila coacher, utvärderade Microsoft 365 Copilot ur ett cybersäkerhetsperspektiv och tog fram en AI-FAQ.",
      "projects.5.r": "Resultat: Tydligare riktlinjer för var data får behandlas och vad som gäller för infosäkerhetsklassad dokumentation.",
      "projects.6.tag": "Kundleverans",
      "projects.6.title": "Säljstödsystem för extern kund",
      "projects.6.s": "Situation: En extern kund behövde ett nytt säljstödsystem utvecklat i agil takt, med två utvecklarpraktikanter i teamet.",
      "projects.6.a": "Insats: Ledde planering och krav → backlog, Epic- och User Story-breakdowns, koordinerade utvecklarteamet och följde upp i GitHub.",
      "projects.6.r": "Resultat: Levererad kundlösning med tydlig kommunikation och uppföljning genom hela projektet.",
    ...
    en: {
      ...
      "projects.2.tag": "Data quality & traceability",
      "projects.2.title": "“Identitetsregister” — Identity Register Consolidation",
      "projects.2.s": "Situation: Identities — including machine/system identities — were scattered across Trafikförvaltningen and among partners, subcontractors, and transport operators, making oversight and traceability difficult.",
      "projects.2.a": "Action: Contributed to a large-scale project consolidating these into a shared identity register, with a focus on security, traceability, and data quality across the entire ecosystem of parties.",
      "projects.2.r": "Result: Improved visibility into all identities — human and non-human — across the full supply chain, strengthening both security and data quality.",
      "projects.3.tag": "Operations & IGA",
      "projects.3.title": "“Identitetssäkerhet” — Omada Operations Support",
      "projects.3.s": "Situation: An ongoing operational project around Omada (the IGA system) needed support with follow-up and documentation management.",
      "projects.3.a": "Action: Supported as a specialist in following up on Omada, responsible for documentation management, records handling, and ongoing coordination.",
      "projects.3.r": "Result: A smaller but important operational project that kept the system and its documentation in good shape.",
      "projects.4.tag": "Governance",
      "projects.4.title": "From PowerPoint to Atlassian",
      "projects.4.s": "Situation: Project planning for the “Operational Security” group was done manually in PowerPoint — hard to track real-time status for 28 people.",
      "projects.4.a": "Action: Migrated the entire planning process to a dynamic Jira/Atlassian view, introduced DoR/DoD as delivery criteria, and ran workshops for both employees and consultants.",
      "projects.4.r": "Result: A shared, up-to-date overview for 5 teams and clearer delivery criteria across the group.",
      "projects.5.tag": "AI & security",
      "projects.5.title": "AI Champions",
      "projects.5.s": "Situation: Need for unified guidance on AI tools (e.g. Copilot) grounded in NIS2, GDPR, and information security.",
      "projects.5.a": "Action: Drove the initiative together with other project managers and agile coaches, evaluated Microsoft 365 Copilot from a cybersecurity perspective, and produced an AI FAQ.",
      "projects.5.r": "Result: Clearer guidelines on where data may be processed and what applies to information-security-classified documentation.",
      "projects.6.tag": "Client delivery",
      "projects.6.title": "Sales-support system for an external client",
      "projects.6.s": "Situation: An external client needed a new sales-support system built at agile pace, with two developer interns on the team.",
      "projects.6.a": "Action: Led planning and requirements → backlog, epic and user-story breakdowns, coordinated the development team, and tracked progress in GitHub.",
      "projects.6.r": "Result: Delivered client solution with clear communication and follow-up throughout the project.",
  ...
  function applyLang(lang) {
    ...
    if (cvLink) {
      cvLink.setAttribute(
        "href",
        lang === "en" ? "assets/cv/CV_Ibrahim_Njie_EN.pdf" : "assets/cv/CV_Ibrahim_Njie_SV.pdf"
      );
    }
