...
(function () {
  ...
  const dict = {
    sv: {
      ...
      "projects.3.s": "Situation: Identiteter — inklusive maskin-/systemidentiteter — var spridda över Trafikförvaltningen och bland partners, underleverantörer och trafikutövare, vilket försvårade överblick och spårbarhet.",
    ...
    en: {
      ...
      "projects.3.s": "Situation: Identities — including machine/system identities — were scattered across Trafikförvaltningen and among partners, subcontractors, and transport operators, making oversight and traceability difficult.",
