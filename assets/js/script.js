...
(function () {
  ...
  const dict = {
    sv: {
      ...
      "projects.1.tag": "Governance",
      "projects.1.title": "Från PowerPoint till Atlassian",
      "projects.1.s": "Situation: Projektplanering för gruppen “Operativ säkerhet” skedde manuellt i PowerPoint — svårt att följa upp status i realtid för 28 personer.",
      "projects.1.a": "Insats: Migrerade hela planeringen till en dynamisk Jira/Atlassian-vy, tog fram DoR/DoD som leveranskriterier och höll workshops för både fastanställda och konsulter.",
      "projects.1.r": "Resultat: Samlad, uppdaterad överblick för 5 team och tydligare leveranskriterier i hela gruppen.",
      "projects.2.tag": "AI & säkerhet",
      "projects.2.title": "AI-Champions",
      "projects.2.s": "Situation: Behov av samlad vägledning kring AI-verktyg (t.ex. Copilot) utifrån NIS2, GDPR och informationssäkerhet.",
      "projects.2.a": "Insats: Drev initiativet tillsammans med andra projektledare och agila coacher, utvärderade Microsoft 365 Copilot ur ett cybersäkerhetsperspektiv och tog fram en AI-FAQ.",
      "projects.2.r": "Resultat: Tydligare riktlinjer för var data får behandlas och vad som gäller för infosäkerhetsklassad dokumentation.",
      "projects.3.tag": "IAM / IGA",
      "projects.3.title": "Identitetssäkerhet i samhällskritisk miljö",
      "projects.3.s": "Situation: Komplext samspel mellan IT, säkerhet, arkitekter och externa leverantörer kring identitetslivscykler.",
      "projects.3.a": "Insats: Koordinerade sourcing- och RFI-processer, deltog i säkerhetsnära forum, arbetade nära Entra ID/AD och access governance.",
      "projects.3.r": "Resultat: Stärkt struktur kring identitetssäkerhet i en av Sveriges mest kritiska IT-miljöer.",
      "projects.4.tag": "Kundleverans",
      "projects.4.title": "Säljstödsystem för extern kund",
      "projects.4.s": "Situation: En extern kund behövde ett nytt säljstödsystem utvecklat i agil takt, med två utvecklarpraktikanter i teamet.",
      "projects.4.a": "Insats: Ledde planering och krav → backlog, Epic- och User Story-breakdowns, koordinerade utvecklarteamet och följde upp i GitHub.",
      "projects.4.r": "Resultat: Levererad kundlösning med tydlig kommunikation och uppföljning genom hela projektet.",
    ...
    en: {
      ...
      "projects.1.tag": "Governance",
      "projects.1.title": "From PowerPoint to Atlassian",
      "projects.1.s": "Situation: Project planning for the “Operational Security” group was done manually in PowerPoint — hard to track real-time status for 28 people.",
      "projects.1.a": "Action: Migrated the entire planning process to a dynamic Jira/Atlassian view, introduced DoR/DoD as delivery criteria, and ran workshops for both employees and consultants.",
      "projects.1.r": "Result: A shared, up-to-date overview for 5 teams and clearer delivery criteria across the group.",
      "projects.2.tag": "AI & security",
      "projects.2.title": "AI Champions",
      "projects.2.s": "Situation: Need for unified guidance on AI tools (e.g. Copilot) grounded in NIS2, GDPR, and information security.",
      "projects.2.a": "Action: Drove the initiative together with other project managers and agile coaches, evaluated Microsoft 365 Copilot from a cybersecurity perspective, and produced an AI FAQ.",
      "projects.2.r": "Result: Clearer guidelines on where data may be processed and what applies to information-security-classified documentation.",
      "projects.3.tag": "IAM / IGA",
      "projects.3.title": "Identity security in a critical environment",
      "projects.3.s": "Situation: Complex interplay between IT, security, architects, and external suppliers around identity lifecycles.",
      "projects.3.a": "Action: Coordinated sourcing and RFI processes, took part in security-focused forums, worked closely with Entra ID/AD and access governance.",
      "projects.3.r": "Result: Strengthened identity-security structure in one of Sweden's most critical IT environments.",
      "projects.4.tag": "Client delivery",
      "projects.4.title": "Sales-support system for an external client",
      "projects.4.s": "Situation: An external client needed a new sales-support system built at agile pace, with two developer interns on the team.",
      "projects.4.a": "Action: Led planning and requirements → backlog, epic and user-story breakdowns, coordinated the development team, and tracked progress in GitHub.",
      "projects.4.r": "Result: Delivered client solution with clear communication and follow-up throughout the project.",
